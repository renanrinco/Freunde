...
@Entity
@Table(name="Cargo", schema="pi2" )
public class Cargo implements Serializable {
    private static final long serialVersionUID = 1L;
    @Id
    @GeneratedValue(strategy = GenerationType.AUTO)
    @Column(name="codigo_cargo",                           // NAME - nome da coluna no BD
    ...
    @Column(name="descricao_cargo",                           // NAME - nome da coluna no BD
    ...
    public String toString() {
        return "ClassesPrincipais.Cargo[ id=" + id + " ]";
    }
